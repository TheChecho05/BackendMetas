...
router.get("/obt", [validarJWT], httpMetas.getMetas);

router.get("/obt/:idusuario", [validarJWT], httpMetas.getMetasByUsuario);
...
router.get(
  "/promediostodosanio/:idusuario/:tipo/:anio",
  httpMetas.getPromediosTodosAnio,
);
